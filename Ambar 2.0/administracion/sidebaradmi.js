...
(function () {
    ...
    const enlacesPrincipales = [
        { texto: 'Alumnos',                  icono: '🏠', url: 'alumnosA.html',               id: 'alumnos' },
        { texto: 'Carga de Materias',                 icono: '📅', url: 'cargademateriasA.html',               id: 'cargadematerias' },
        { texto: 'Kardex',          icono: '📋', url: 'kardexA.html',         id: 'kardex' },
    ];
