// sidebarcoo.js — Barra lateral del Portal Coordinador (sistema Ámbar)
(function () {
    "use strict";

    const navItems = [
        { icon: "🏠", label: "Inicio",                href: "inicio_coord.html" },
        { icon: "📅", label: "Grupos",               href: "grupos_coord.html" },
        { icon: "📋", label: "Alumnos",            href: "alumnos_coord.html" },
    ];
    ...
    function isActive(href) {
        const current = window.location.pathname.split("/").pop() || "inicio_coord.html";
        return current === href;
    }
